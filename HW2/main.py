...
def parse_args():
    ...
    parser.add_argument('doc1', type=str, help='document1')
    parser.add_argument('doc2', type=str, help='document2')
...
if __name__ == "__main__":
    ...
    print("cosine sim for doc {} and {}:".format(args.doc1, args.doc2),cosine(args.doc1, args.doc2))
